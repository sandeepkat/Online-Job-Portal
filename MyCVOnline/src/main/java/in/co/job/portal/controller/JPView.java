...
public interface JPView {
	...
	public String APP_CONTEXT = "/MyCVOnline";
	...
	public String JOB_LIST_VIEW_OPEN = PAGE_FOLDER + "/JobListOpenView.jsp";
	...
	public String CV_VIEW = PAGE_FOLDER + "/CVView.jsp";
	public String CV_VIEW_STATIC = PAGE_FOLDER + "/CVStaticView.jsp";
	...
	public String CHANGE_CV_CTL = APP_CONTEXT + "/ctl/ChangeCV";
	public String MY_PROFILE_CTL = APP_CONTEXT + "/ctl/MyProfileCtl";
	public String FORGET_PASSWORD_CTL = APP_CONTEXT + "/ForgetPasswordCtl";
	public String CHANGECV_CTL = APP_CONTEXT + "/ctl/ChangeCV";
