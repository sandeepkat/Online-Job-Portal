					...
					<div class="card-body">
						...
						<form action="<%=JPView.CHANGECV_CTL%>" method="post">
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input readonly type="text" id="mainSkills"  class="form-control" placeholder="Enter Primary Skills"
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									...
									<input readonly type="text" id="workExperience"  class="form-control" placeholder="Enter Work Experience"
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									...
									<input readonly type="text" id="educaTion"  class="form-control" placeholder="Enter Education"
