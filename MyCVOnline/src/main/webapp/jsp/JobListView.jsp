                    ...
                    <tr>
                      ...
                      <td align="center"><%=DataUtility.getDateString(bean.getPostDate())%></td>
                       <td><%=bean.getPostByRecId()%></td>
                         ...
                         <%if(uBean.getRoleId()==2){ %>
                          <td><a class="form-control" href="JobCtl?id=<%=bean.getId()%>">Edit</a> 
                          <a href="JobListCtl?ids=<%=bean.getId()%>"  class="btn btn-danger" >DELETE</a></td>
                          <%}else{%>
                          
                          <td><a class="btn btn-primary" href="ApplayJobCtl?id=<%=bean.getId()%>">Apply</a> </td>
                        <%} %>
                    </tr>
