...
<title>Header of Welcome View</title>
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    <link href="https://mdbootstrap.com/previews/docs/latest/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://mdbootstrap.com/previews/docs/latest/css/mdb.min.css" rel="stylesheet">
    
    <link rel="stylesheet" href="/MyCVOnline/css/style.css">
...
<%
    ...
    if (userLoggedIn) {
        ...
        session.setAttribute("test","tetesst");
    } else {
...
%>
    <nav class="navbar navbar-expand-lg navbar-dark default-color-dark fixed-top">
        <a class="navbar-brand" href="<%=JPView.WELCOME_CTL%>">MyCVOnline</a>
        ...
        if (userLoggedIn) {
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="<%=JPView.CHANGE_CV_CTL%>">My CV</a>
                </li>
                <%}} %>
             ...
             <ul class="navbar-nav ml-auto nav-flex-icons">
               <li class="nav-item">
				...
				%>
				 ...
				 <li class="nav-item">
                    <a class="nav-link" href="<%=JPView.JOB_LIST_CTL%>">JobList</a>
                </li>
				 <li class="nav-item">
